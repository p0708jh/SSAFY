...
window.addEventListener("scroll",function(){
    ...
    if(value >=500){
        ...
        titleLeft.nextElementSibling.nextElementSibling.style.animation = "disappear_left 1s ease-out forwards";
    }
    else{
        titleLeft.style.animation="appear_left 0.5s ease-out";
        titleLeft.nextElementSibling.style.animation = "appear_left 0.7s ease-out";
        titleLeft.nextElementSibling.nextElementSibling.style.animation = "appear_left 1s ease-out";
    }
    /*    
    if(value >=400)
